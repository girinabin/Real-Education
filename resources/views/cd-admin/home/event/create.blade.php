			...
			<form role="form" action="{{ route('event.store') }}" method="POST">
				...
				<div class="card-body">
					<div class="form-group">
						...
						<input type="text" class="form-control" id="title" placeholder="Enter Event Title" name="title" value="{{old('title')}}">
					</div>
					...
					<div class="form-group">
						...
						<div class="input-group">
							...
							<input type="text
							" class="form-control float-right" id="reservationtime" name="time"  >
						</div>
						<!-- /.input group -->
					</div>
