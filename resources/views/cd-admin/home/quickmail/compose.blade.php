  ...
  <div class="container-fluid">
    ...
    <div class="col-md-12">
      <div class="card card-primary card-outline">
        ...
        <!-- /.card-header -->
        <div class="card-body">
          <form action="{{ route('eregister.reply1',$quick->id) }}" method="POST">
            @csrf
            <div class="form-group">
              <input class="form-control" placeholder="To:" value="{{e($quick['emailto'])}}" name="emailto">
            </div>
            <div class="form-group">
            ...
            <input type="hidden" name="contact_id" value="{{$quick['id']}}">
